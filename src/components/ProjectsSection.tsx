...
const projects = [
  ...
  },
  {
    ...
    description: 'Decentralized application with smart contract integration, zero-knowledge proofs, and cross-chain compatibility.',
  ...
  {
    title: 'Game UI/UX System',
    category: 'INTERACTIVE DESIGN',
    description: 'High-performance game interface system built with Unity, featuring dynamic HUD elements and adaptive layouts.',
    tech: ['Unity', 'C#', 'Figma', 'Firebase'],
    status: 'SHIPPED',
  },
];
